...
function bindEvents() {
  ...
  var showTooltip = function showTooltip(point) {
    if (_this7.tooltip) {
      var _this7$tooltip = _this7.tooltip,
          cross = _this7$tooltip.cross,
          compute = _this7$tooltip.compute;
      ...
      if (crossX || crossY) {
        ...
        var _compute = compute([x0, y0], getScaleAxis.call(_this7)),
            x00 = _compute.x0,
            y00 = _compute.y0,
  ...
  var hideTooltip = function hideTooltip(target) {
    if (_this7.tooltip) {
      var cross = _this7.tooltip.cross;
      var zNode = element;
  ...
  var element = selection.call(this.zoomer$.on('start', function (_ref15, _ref16) {
    ...
    if (type !== 'call' && (_this7.xCanZoom$ || _this7.yCanZoom$)) {
      var p = null;
    ...
    _this7.zoomstart$.call(null, _objectSpread(_objectSpread({}, restEvent), {}, {
    ...
    if (type !== 'call') {
      ...
      if (touches) {
        ...
        if (point[0]) {
          p = np || point[0][0];
          lx = _this7.xCanZoom$ && point[0][1][0];
          ly = _this7.yCanZoom$ && point[0][1][1];
          ...
          if (point[1]) {
            ...
            lx = _this7.xCanZoom$ && [(lx[0] + lx1[0]) / 2, (lx[1] + lx1[1]) / 2];
            ly = _this7.yCanZoom$ && [(ly[0] + ly1[0]) / 2, (ly[1] + ly1[1]) / 2];
          }
        }
      } else {
        p = d3.pointer(sourceEvent, element);
        ...
        lx = _this7.xCanZoom$ && (wheel && changed ? xTransform.invert(p) : point[1][0]);
        ly = _this7.yCanZoom$ && (wheel && changed ? yTransform.invert(p) : point[1][1]);
      }

      if (p) {
        if (lx) {
          newXTransform = _this7.transform$('x', xTransform, t, p, lx);
        }

        if (ly) {
          newYTransform = _this7.transform$('y', yTransform, t, p, ly);
        }
      }
      ...
      if (Array.isArray(eventTransform)) {
        ...
        if (!_this7.xCanZoom$) xtf = eventTransform;
        if (!_this7.yCanZoom$) ytf = eventTransform;
      }
    ...
    _this7.zooming$.call(null, _objectSpread(_objectSpread({}, restEvent), {}, {
      sourceEvent: sourceEvent,
    ...
    if (sourceEvent.type !== 'call' && (_this7.xCanZoom$ || _this7.yCanZoom$)) {
      point = null;
      transform0 = null;
    }
    ...
    _this7.zoomend$.call(null, _objectSpread(_objectSpread({}, restEvent), {}, {
      sourceEvent: sourceEvent,
      transform: [transform, xTransform, yTransform],
      scaleAxis: getScaleAxis.call(_this7)
    }));
  ...
  if (this.zoom.x) {
    ...
    xlock.on('click', function () {
      ...
      _this7.setCanZoom('x', !_this7.xCanZoom$);
  ...
  if (this.zoom.y) {
    ...
    ylock.on('click', function () {
      ...
      _this7.setCanZoom('y', !_this7.yCanZoom$);
    ...
    this.tooltip = !tooltip ? false : _objectSpread(_objectSpread({
      ...
      compute: function compute() {
        ...
        if (typeof tooltip.compute === 'function') {
          ...
          result = (_tooltip$compute = tooltip.compute).call.apply(_tooltip$compute, [_this8, result].concat(args));
        }
