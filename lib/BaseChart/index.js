...
function updateElement(size) {
  ...
  if (this.scale.x) {
    ...
    group.select('.xLabel').attr('transform', "translate(".concat(zw / 2, " ").concat(zh + padding[2] - 2, ") rotate(0)"));
  } // @ts-ignore


  if (this.scale.x2) {
    // @ts-ignore
    group.select('.x2Label').attr('transform', "translate(".concat(zw / 2, " ").concat(this.fontSize - padding[0], ") rotate(0)"));
  } // @ts-ignore


  if (this.scale.y) {
    // @ts-ignore
    group.select('.yLabel').attr('transform', "translate(".concat(this.fontSize - padding[3], " ").concat(zh / 2, ") rotate(-90)"));
  } // @ts-ignore
  ...
  if (this.scale.y2) {
    ...
    group.select('.y2Label').attr('transform', "translate(".concat(zw + padding[1], " ").concat(zh / 2, ") rotate(-90)"));
  } // @ts-ignore
  ...
  if (this.zoom.x) {
    ...
    .style('top', "".concat(zh + padding[2] - 21, "px")).style('left', "".concat(zw - 12, "px"));
  } // @ts-ignore
  ...
  if (this.zoom.x || this.zoom.y) {
    ...
    .style('top', "".concat(-padding[0] - 3, "px")) // @ts-ignore
    .style('left', "".concat(this.scale.y ? zw - offset - this.fontSize : offset, "px"));
    offset += 23;
  } // @ts-ignore
