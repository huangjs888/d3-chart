...
function drawing(zContext, _ref5) {
  ...
  var HeatMap = /*#__PURE__*/function (_BaseChart) {
    ...
    function HeatMap() {
      ...
      var _ref10 = (arguments.length <= 0 ? undefined : arguments[0]) || {},
          data = _ref10.data,
          tooptip = _ref10.tooptip,
          colorBar = _ref10.colorBar,
          scale = _ref10.scale,
      ...
      _this.scale.x ? baselineDelt - _this.padding[0] : _this.height$ + _this.padding[2] - iconSize + baselineDelt, ")"));
