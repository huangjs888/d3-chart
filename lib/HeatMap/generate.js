...
function generateHeatMap(superName) {
  var HeatMap = /*#__PURE__*/function (_BaseChart) {
    ...
    function HeatMap() {
      ...
      _this.scale.x ? _this.fontSize - _this.padding[0] : _this.height$ + _this.padding[2] - 2, ")"));
      ...
      _this.resize$ = function (e, _ref15) {
        ...
        heatLabel.attr('transform', "translate(".concat(_this.scale.y ? 10 : width - 10, ",").concat(_this.scale.x ? _this.fontSize - padding[0] : height + padding[2] - 2, ")"));
