...
function lineLabel() {
  ...
  var totalWidth = 0;
  this.rootSelection$.select('.zLabel').selectAll('g.line-legend') // @ts-ignore
  .each(function (d, i, g) {
    ...
    return enter.append('g').attr('class', 'line-legend').attr('transform', function (d, i, g) {
      ...
      var width = util.measureSvgText(d.label, _this.fontSize) + dx + 5;
      totalWidth -= width;
      ...
      if (onlyOneMerge) {
        totalWidth -= (_this.width$ - (width - 5)) / 2;
      }
