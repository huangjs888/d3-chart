      ...
      tooltip: !tooltip ? false : _objectSpread(_objectSpread({
        ...
        compute: function compute(res) {
          ...
          if (typeof tooltip.compute === 'function') {
            ...
            result = (_tooltip$compute = tooltip.compute).call.apply(_tooltip$compute, [(0, _assertThisInitialized2.default)(_this2), result].concat(args));
          }
