...
function setPrototypeOf(subClass, superClass) {
  ...
  if (superClass) Object.setPrototypeOf(subClass, superClass);else Object.setPrototypeOf(subClass, Function.prototype); // 设置函数prototype（原型）的__proto__
...
function replace(subClass, newSuperClass) {
  var oldSuperClass = Object.getPrototypeOf(subClass);
